...
The plugin (v1.6.18) now bundles everything in one package:
...
The plugin (v1.6.18) enforces the epistemic transaction workflow and preserves epistemic state automatically.
