...
The plugin (v1.5.3) now bundles everything in one package:
...
The plugin (v1.5.3) enforces the CASCADE workflow and preserves epistemic state automatically.
