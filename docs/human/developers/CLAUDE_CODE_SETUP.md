...
The plugin (v1.6.19) now bundles everything in one package:
...
The plugin (v1.6.19) enforces the epistemic transaction workflow and preserves epistemic state automatically.
