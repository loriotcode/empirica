...
The plugin (v1.6.0) now bundles everything in one package:
...
The plugin (v1.6.0) enforces the CASCADE workflow and preserves epistemic state automatically.
