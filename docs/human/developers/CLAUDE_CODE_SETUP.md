...
The plugin (v1.5.9) now bundles everything in one package:
...
The plugin (v1.5.9) enforces the CASCADE workflow and preserves epistemic state automatically.
