...
The plugin (v1.6.2) now bundles everything in one package:
...
The plugin (v1.6.2) enforces the CASCADE workflow and preserves epistemic state automatically.
