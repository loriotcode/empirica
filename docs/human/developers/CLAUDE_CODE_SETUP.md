...
The plugin (v1.6.17) now bundles everything in one package:
...
The plugin (v1.6.17) enforces the epistemic transaction workflow and preserves epistemic state automatically.
