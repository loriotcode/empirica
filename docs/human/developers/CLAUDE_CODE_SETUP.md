...
The plugin (v1.5.6) now bundles everything in one package:
...
The plugin (v1.5.6) enforces the CASCADE workflow and preserves epistemic state automatically.
