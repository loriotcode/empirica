...
The plugin (v1.6.5) now bundles everything in one package:
...
The plugin (v1.6.5) enforces the CASCADE workflow and preserves epistemic state automatically.
