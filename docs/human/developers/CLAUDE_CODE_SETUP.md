...
The plugin (v1.6.16) now bundles everything in one package:
...
The plugin (v1.6.16) enforces the epistemic transaction workflow and preserves epistemic state automatically.
