...
The plugin (v1.5.5) now bundles everything in one package:
...
The plugin (v1.5.5) enforces the CASCADE workflow and preserves epistemic state automatically.
