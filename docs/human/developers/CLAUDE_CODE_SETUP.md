...
The plugin (v1.5.8) now bundles everything in one package:
...
The plugin (v1.5.8) enforces the CASCADE workflow and preserves epistemic state automatically.
