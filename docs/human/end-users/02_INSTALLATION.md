...
```bash
# Standard image
docker pull nubaeon/empirica:1.7.5

# Security-hardened Alpine (recommended)
docker pull nubaeon/empirica:1.7.5-alpine

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.7.5 /bin/bash
```
