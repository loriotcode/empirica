...
- `parent_session_id: Optional[str]` - **(since v1.8.5)** Optional parent session UUID
...
**Migration 034** (v1.8.5) introduces a dedicated `subagent_sessions`
