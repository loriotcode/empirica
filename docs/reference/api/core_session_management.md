...
- `parent_session_id: Optional[str]` - **(since v1.8.7)** Optional parent session UUID
...
**Migration 034** (v1.8.7) introduces a dedicated `subagent_sessions`
