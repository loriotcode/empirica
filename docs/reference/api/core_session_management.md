...
- `parent_session_id: Optional[str]` - **(since v1.7.13)** Optional parent session UUID
...
**Migration 034** (v1.7.13) introduces a dedicated `subagent_sessions`
