...
- `EMPIRICA_EPISTEMIC_MODE`: **Deprecated in 1.7.7.** Epistemic middleware was removed from MCP server (Sentinel handles gating via hooks). This env var has no effect.
