...
- `EMPIRICA_EPISTEMIC_MODE`: **Deprecated in 1.7.13.** Epistemic middleware was removed from MCP server (Sentinel handles gating via hooks). This env var has no effect.
