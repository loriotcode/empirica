...
- `EMPIRICA_AUTO_POSTFLIGHT`: **REMOVED in 1.6.5.** Auto-POSTFLIGHT from CHECK was removed because CHECK is a noetic→praxic gate, not a completion event. POSTFLIGHT should only be triggered by the AI or session-end hook after actual work is done
