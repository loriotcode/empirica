...
- `EMPIRICA_EPISTEMIC_MODE`: **Deprecated in 1.8.7.** Epistemic middleware was removed from MCP server (Sentinel handles gating via hooks). This env var has no effect.
...
**Layer 2.5: Work-Type Category Weights (1.8.7+)**
