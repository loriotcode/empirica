...
**Status:** IMPLEMENTED (Phases 1-3 complete, domain-aware thresholds in v1.8.11)
**Author:** David + Claude Code
**Date:** 2026-02-10 (updated 2026-04-09)
**Depends on:** Grounded Calibration (v1.5.0), Sentinel Architecture, CHECK Gate, Domain Registry (v1.8.11)
...
demonstrated belief calibration. In v1.8.11, domain criticality further scales
the uncertainty threshold via the Domain Registry (`DomainRegistry.resolve()`).

**Key principle (v1.8.11):** Deterministic services produce **observed vectors** —
...
### Uncertainty Exclusion from Calibration Score (v1.8.11)
...
### Phase 3: Dynamic Thresholds -- COMPLETE (v1.8.11)
...
### Phase 4: Domain-Scoped Autonomy -- PARTIALLY COMPLETE (v1.8.11)
