...
# Copy package files
COPY dist/empirica-1.6.12-py3-none-any.whl /tmp/

# Install Empirica with security flags
RUN pip install --no-cache-dir --no-compile /tmp/empirica-1.6.12-py3-none-any.whl \
    && rm /tmp/empirica-1.6.12-py3-none-any.whl \
