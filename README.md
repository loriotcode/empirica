...
[![Version](https://img.shields.io/badge/version-1.6.12-blue)](https://github.com/Nubaeon/empirica/releases/tag/v1.6.12)
...
docker pull nubaeon/empirica:1.6.12-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.6.12

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.6.12 /bin/bash
```
</details>
