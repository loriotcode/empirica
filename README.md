...
[![Version](https://img.shields.io/badge/version-1.6.16-blue)](https://github.com/Nubaeon/empirica/releases/tag/v1.6.16)
...
docker pull nubaeon/empirica:1.6.16-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.6.16

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.6.16 /bin/bash
```
</details>
...
### Previous Highlights (1.6.11–1.6.16)
