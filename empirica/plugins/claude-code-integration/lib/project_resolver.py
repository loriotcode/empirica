...
def detect_environment() -> dict:
    ...
    Delegates to canonical when available (v1.8.8 resolver dedup).
...
# ---------------------------------------------------------------------------
# Delegated to canonical session_resolver.py (v1.8.8 resolver dedup)
...
def find_project_root(
    ...
    *,
    ...
    when available (v1.8.8 resolver dedup). Falls back to inline implementation
    ...
    """
    # Delegate to canonical when available (v1.8.8 resolver dedup)
    try:
