...
**When to CHECK:**
- After noetic work when confidence has evolved
- Post-compact (context was just reduced)
- Before irreversible actions
- Sentinel returns `investigate` from PREFLIGHT
...
**Decision:**
Sentinel evaluates your vectors and returns:
- **Proceed:** Ready to act
- **Investigate:** More understanding needed

Respond to Sentinel's decision — don't try to predict the threshold.
