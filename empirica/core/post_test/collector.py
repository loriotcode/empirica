...
class PostTestCollector:
    ...
    def _get_transaction_edited_files(self) -> list[str]:
        ...
        every Edit/Write tool call to the hook_counters file (since v1.7.11).
        ...
        # Try hook_counters file first (v1.7.11+), then fall back to transaction file
        search_dirs = []
        if project_root:
        ...
        for empirica_dir in search_dirs:
            # Primary: hook_counters file (hook-owned since v1.7.11)
            ...
            if counters_path.exists():
                try:
                    ...
                    pass
            # Fallback: active_transaction (pre-v1.7.11 compat)
