...
_HELP_CATEGORIES = {
    ...
    'logging': ['finding-log', 'unknown-log', 'unknown-list', 'unknown-resolve', 'deadend-log', 'assumption-log', 'decision-log', 'mistake-log', 'mistake-query', 'refdoc-add', 'source-add', 'act-log', 'investigate-log', 'log-artifacts', 'resolve-artifacts'],
...
def main(args=None):
    ...
    try:
        command_handlers = {
            ...
            'log-artifacts': handle_log_artifacts_command,
            'resolve-artifacts': handle_resolve_artifacts_command,
