...
class Empirica < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/e/empirica/empirica-1.6.15.tar.gz"
  sha256 "80bfc0e4720b1ce674084c1f7e0f1f9d37242e0fbe74cadf8c0015d5e0f06db7"
  license "MIT"
  ...
  test do
    ...
    assert_match "1.6.15", shell_output("#{bin}/empirica --version")
