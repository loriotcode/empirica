...
class Empirica < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/e/empirica/empirica-1.6.16.tar.gz"
  sha256 "cbb01548761b7c6656dbcfea2a65821be943cb632dd9ea79d0f54a699511532b"
  license "MIT"
  ...
  test do
    ...
    assert_match "1.6.16", shell_output("#{bin}/empirica --version")
